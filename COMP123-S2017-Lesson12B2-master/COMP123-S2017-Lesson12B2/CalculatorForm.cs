...
namespace COMP123_S2017_Lesson12B2
{
    public partial class CalculatorForm : Form
    {
        ...
        /// <summary>
        /// This method removes the last entered digit
        /// </summary>
        private void _backspace(double input)
        {
            string inputString = input.ToString();
            if (inputString.Length > 1)
            {
                this.ResultTextBox.Text = inputString.Substring(0, inputString.Length - 1);
            }
            else
            {
